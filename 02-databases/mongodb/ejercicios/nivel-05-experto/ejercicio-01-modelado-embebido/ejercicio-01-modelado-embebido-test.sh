#!/usr/bin/env bash
# Verificación: ejercicio-01-modelado-embebido
set -u
cd "$(dirname "$0")" || exit 1

CTR="mongo-ej-$$"
WORK="$(pwd)"
SETUP="ejercicio-01-modelado-embebido-setup.js"
SOL="ejercicio-01-modelado-embebido-solucion.js"
EXPECTED="ejercicio-01-modelado-embebido-expected.txt"
