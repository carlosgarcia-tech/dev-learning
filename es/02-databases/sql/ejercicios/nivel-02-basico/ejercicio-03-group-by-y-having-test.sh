#!/usr/bin/env bash
# Verificación: ejercicio-03-group-by-y-having
set -u
cd "$(dirname "$0")" || exit 1

DB="tmp.db"
SCHEMA="ejercicio-03-group-by-y-having-schema.sql"
SOL="ejercicio-03-group-by-y-having-solucion.sql"
EXPECTED="ejercicio-03-group-by-y-having-expected.txt"
