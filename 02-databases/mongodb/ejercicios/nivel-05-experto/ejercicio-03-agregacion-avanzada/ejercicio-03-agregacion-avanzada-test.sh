#!/usr/bin/env bash
# Verificación: ejercicio-03-agregacion-avanzada
set -u
cd "$(dirname "$0")" || exit 1

CTR="mongo-ej-$$"
WORK="$(pwd)"
SETUP="ejercicio-03-agregacion-avanzada-setup.js"
SOL="ejercicio-03-agregacion-avanzada-solucion.js"
EXPECTED="ejercicio-03-agregacion-avanzada-expected.txt"
