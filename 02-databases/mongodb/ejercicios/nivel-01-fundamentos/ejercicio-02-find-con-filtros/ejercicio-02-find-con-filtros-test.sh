#!/usr/bin/env bash
# Verificación: ejercicio-02-find-con-filtros
set -u
cd "$(dirname "$0")" || exit 1

CTR="mongo-ej-$$"
WORK="$(pwd)"
SETUP="ejercicio-02-find-con-filtros-setup.js"
SOL="ejercicio-02-find-con-filtros-solucion.js"
EXPECTED="ejercicio-02-find-con-filtros-expected.txt"
