#!/usr/bin/env bash
# Verificación: ejercicio-02-left-y-right-join
set -u
cd "$(dirname "$0")" || exit 1

DB="tmp.db"
SCHEMA="ejercicio-02-left-y-right-join-schema.sql"
SOL="ejercicio-02-left-y-right-join-solucion.sql"
EXPECTED="ejercicio-02-left-y-right-join-expected.txt"
