#!/usr/bin/env bash
# Verificación: ejercicio-06-condicionales
set -u
cd "$(dirname "$0")" || exit 1

CTR="mongo-ej-$$"
WORK="$(pwd)"
SETUP="ejercicio-06-condicionales-setup.js"
SOL="ejercicio-06-condicionales-solucion.js"
EXPECTED="ejercicio-06-condicionales-expected.txt"
