#!/usr/bin/env bash
# Verificación: ejercicio-01-joins-multiples
set -u
cd "$(dirname "$0")" || exit 1

DB="tmp.db"
SCHEMA="ejercicio-01-joins-multiples-schema.sql"
SOL="ejercicio-01-joins-multiples-solucion.sql"
EXPECTED="ejercicio-01-joins-multiples-expected.txt"
