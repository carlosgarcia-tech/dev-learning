#!/usr/bin/env bash
# Verificación: ejercicio-03-lookup-join
set -u
cd "$(dirname "$0")" || exit 1

CTR="mongo-ej-$$"
WORK="$(pwd)"
SETUP="ejercicio-03-lookup-join-setup.js"
SOL="ejercicio-03-lookup-join-solucion.js"
EXPECTED="ejercicio-03-lookup-join-expected.txt"
