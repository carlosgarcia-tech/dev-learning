#!/usr/bin/env bash
# Verificación: ejercicio-03-transacciones
set -u
cd "$(dirname "$0")" || exit 1

DB="tmp.db"
SCHEMA="ejercicio-03-transacciones-schema.sql"
SOL="ejercicio-03-transacciones-solucion.sql"
CHECK="ejercicio-03-transacciones-check.sql"
EXPECTED="ejercicio-03-transacciones-expected.txt"
...
# Ejecutar la solución (transacciones)
