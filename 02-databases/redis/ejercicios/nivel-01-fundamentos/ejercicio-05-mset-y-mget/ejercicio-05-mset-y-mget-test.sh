#!/usr/bin/env bash
# Verificación: ejercicio-05-mset-y-mget
set -u
cd "$(dirname "$0")" || exit 1

CTR="redis-ej-$$"
SETUP="ejercicio-05-mset-y-mget-setup.redis"
SOL="ejercicio-05-mset-y-mget-solucion.redis"
EXPECTED="ejercicio-05-mset-y-mget-expected.txt"
