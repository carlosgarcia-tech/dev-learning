#!/usr/bin/env bash
# Verificación: ejercicio-02-migraciones
set -u
cd "$(dirname "$0")" || exit 1

DB="tmp.db"
SCHEMA="ejercicio-02-migraciones-schema.sql"
SOL="ejercicio-02-migraciones-solucion.sql"
CHECK="ejercicio-02-migraciones-check.sql"
EXPECTED="ejercicio-02-migraciones-expected.txt"
