#!/usr/bin/env bash
# Verificación: ejercicio-01-inner-join
set -u
cd "$(dirname "$0")" || exit 1

DB="tmp.db"
SCHEMA="ejercicio-01-inner-join-schema.sql"
SOL="ejercicio-01-inner-join-solucion.sql"
EXPECTED="ejercicio-01-inner-join-expected.txt"
