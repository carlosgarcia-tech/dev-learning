#!/usr/bin/env bash
# Verificación: ejercicio-05-upsert-y-arrays
set -u
cd "$(dirname "$0")" || exit 1

CTR="mongo-ej-$$"
WORK="$(pwd)"
SETUP="ejercicio-05-upsert-y-arrays-setup.js"
SOL="ejercicio-05-upsert-y-arrays-solucion.js"
EXPECTED="ejercicio-05-upsert-y-arrays-expected.txt"
