#!/usr/bin/env bash
# Verificación: ejercicio-03-regex-y-existe
set -u
cd "$(dirname "$0")" || exit 1

CTR="mongo-ej-$$"
WORK="$(pwd)"
SETUP="ejercicio-03-regex-y-existe-setup.js"
SOL="ejercicio-03-regex-y-existe-solucion.js"
EXPECTED="ejercicio-03-regex-y-existe-expected.txt"
