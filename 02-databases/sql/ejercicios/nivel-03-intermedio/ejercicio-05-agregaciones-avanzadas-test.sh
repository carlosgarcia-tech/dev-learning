#!/usr/bin/env bash
# Verificación: ejercicio-05-agregaciones-avanzadas
set -u
cd "$(dirname "$0")" || exit 1

DB="tmp.db"
SCHEMA="ejercicio-05-agregaciones-avanzadas-schema.sql"
SOL="ejercicio-05-agregaciones-avanzadas-solucion.sql"
EXPECTED="ejercicio-05-agregaciones-avanzadas-expected.txt"
