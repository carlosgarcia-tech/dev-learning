#!/usr/bin/env bash
# Verificación: ejercicio-05-triggers
set -u
cd "$(dirname "$0")" || exit 1

DB="tmp.db"
SCHEMA="ejercicio-05-triggers-schema.sql"
SOL="ejercicio-05-triggers-solucion.sql"
CHECK="ejercicio-05-triggers-check.sql"
EXPECTED="ejercicio-05-triggers-expected.txt"
...
# Ejecutar la solución (DDL + DML con triggers)
