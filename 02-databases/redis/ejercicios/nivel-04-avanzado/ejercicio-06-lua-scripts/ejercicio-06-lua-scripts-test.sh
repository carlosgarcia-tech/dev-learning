#!/usr/bin/env bash
# Verificación: ejercicio-06-lua-scripts
set -u
cd "$(dirname "$0")" || exit 1

CTR="redis-ej-$$"
SETUP="ejercicio-06-lua-scripts-setup.redis"
SOL="ejercicio-06-lua-scripts-solucion.redis"
EXPECTED="ejercicio-06-lua-scripts-expected.txt"
