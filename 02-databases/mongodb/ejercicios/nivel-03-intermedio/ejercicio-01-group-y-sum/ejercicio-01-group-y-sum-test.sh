#!/usr/bin/env bash
# Verificación: ejercicio-01-group-y-sum
set -u
cd "$(dirname "$0")" || exit 1

CTR="mongo-ej-$$"
WORK="$(pwd)"
SETUP="ejercicio-01-group-y-sum-setup.js"
SOL="ejercicio-01-group-y-sum-solucion.js"
EXPECTED="ejercicio-01-group-y-sum-expected.txt"
