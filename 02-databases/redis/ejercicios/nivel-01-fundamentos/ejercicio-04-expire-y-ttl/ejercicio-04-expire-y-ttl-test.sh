#!/usr/bin/env bash
# Verificación: ejercicio-04-expire-y-ttl
set -u
cd "$(dirname "$0")" || exit 1

CTR="redis-ej-$$"
SETUP="ejercicio-04-expire-y-ttl-setup.redis"
SOL="ejercicio-04-expire-y-ttl-solucion.redis"
EXPECTED="ejercicio-04-expire-y-ttl-expected.txt"
