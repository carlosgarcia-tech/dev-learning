...
-- PERCENTILE_CONT y STDDEV no existen en SQLite: la solución usa
-- ROW_NUMBER()/COUNT(*) con aritmética entera para los cuantiles y
-- SQRT(AVG(precio*precio) - AVG(precio)*AVG(precio)) para la desviación.
