#!/usr/bin/env bash
# Verificación: ejercicio-03-listas-avanzadas
set -u
cd "$(dirname "$0")" || exit 1

CTR="redis-ej-$$"
SETUP="ejercicio-03-listas-avanzadas-setup.redis"
SOL="ejercicio-03-listas-avanzadas-solucion.redis"
EXPECTED="ejercicio-03-listas-avanzadas-expected.txt"
