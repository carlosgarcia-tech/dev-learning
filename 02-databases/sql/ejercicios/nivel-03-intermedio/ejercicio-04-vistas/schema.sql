...
-- Este ejercicio usa DATE_TRUNC(), una función específica de PostgreSQL
-- que no existe en SQLite, por lo que requiere una instancia real de
-- PostgreSQL para ejecutarse (ver test.sh).
