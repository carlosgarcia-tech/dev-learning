#!/usr/bin/env bash
# Verificación: ejercicio-02-indices-compuestos
set -u
cd "$(dirname "$0")" || exit 1

CTR="mongo-ej-$$"
WORK="$(pwd)"
SETUP="ejercicio-02-indices-compuestos-setup.js"
SOL="ejercicio-02-indices-compuestos-solucion.js"
EXPECTED="ejercicio-02-indices-compuestos-expected.txt"
