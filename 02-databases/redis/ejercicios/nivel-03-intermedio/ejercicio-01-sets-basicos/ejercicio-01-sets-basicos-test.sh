#!/usr/bin/env bash
# Verificación: ejercicio-01-sets-basicos
set -u
cd "$(dirname "$0")" || exit 1

CTR="redis-ej-$$"
SETUP="ejercicio-01-sets-basicos-setup.redis"
SOL="ejercicio-01-sets-basicos-solucion.redis"
EXPECTED="ejercicio-01-sets-basicos-expected.txt"
