#!/usr/bin/env bash
# Verificación: ejercicio-04-hashes-basicos
set -u
cd "$(dirname "$0")" || exit 1

CTR="redis-ej-$$"
SETUP="ejercicio-04-hashes-basicos-setup.redis"
SOL="ejercicio-04-hashes-basicos-solucion.redis"
EXPECTED="ejercicio-04-hashes-basicos-expected.txt"
