#!/usr/bin/env bash
# Verificación: ejercicio-01-insert-y-find
set -u
cd "$(dirname "$0")" || exit 1

CTR="mongo-ej-$$"
WORK="$(pwd)"
SETUP="ejercicio-01-insert-y-find-setup.js"
SOL="ejercicio-01-insert-y-find-solucion.js"
EXPECTED="ejercicio-01-insert-y-find-expected.txt"
