#!/usr/bin/env bash
# Verificación: ejercicio-01-cache-aside
set -u
cd "$(dirname "$0")" || exit 1

CTR="redis-ej-$$"
SETUP="ejercicio-01-cache-aside-setup.redis"
SOL="ejercicio-01-cache-aside-solucion.redis"
EXPECTED="ejercicio-01-cache-aside-expected.txt"
