#!/usr/bin/env bash
# Verificación: ejercicio-03-indices-texto
set -u
cd "$(dirname "$0")" || exit 1

CTR="mongo-ej-$$"
WORK="$(pwd)"
SETUP="ejercicio-03-indices-texto-setup.js"
SOL="ejercicio-03-indices-texto-solucion.js"
EXPECTED="ejercicio-03-indices-texto-expected.txt"
