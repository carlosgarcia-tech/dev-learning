#!/usr/bin/env bash
# Verificación: ejercicio-04-update-y-delete
set -u
cd "$(dirname "$0")" || exit 1

DB="tmp.db"
SCHEMA="ejercicio-04-update-y-delete-schema.sql"
SOL="ejercicio-04-update-y-delete-solucion.sql"
CHECK="ejercicio-04-update-y-delete-check.sql"
EXPECTED="ejercicio-04-update-y-delete-expected.txt"
