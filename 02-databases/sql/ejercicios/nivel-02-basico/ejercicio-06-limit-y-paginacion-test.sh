#!/usr/bin/env bash
# Verificación: ejercicio-06-limit-y-paginacion
set -u
cd "$(dirname "$0")" || exit 1

DB="tmp.db"
SCHEMA="ejercicio-06-limit-y-paginacion-schema.sql"
SOL="ejercicio-06-limit-y-paginacion-solucion.sql"
EXPECTED="ejercicio-06-limit-y-paginacion-expected.txt"
