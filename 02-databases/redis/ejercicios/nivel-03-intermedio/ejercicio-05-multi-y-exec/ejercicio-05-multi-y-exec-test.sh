#!/usr/bin/env bash
# Verificación: ejercicio-05-multi-y-exec
set -u
cd "$(dirname "$0")" || exit 1

CTR="redis-ej-$$"
SETUP="ejercicio-05-multi-y-exec-setup.redis"
SOL="ejercicio-05-multi-y-exec-solucion.redis"
EXPECTED="ejercicio-05-multi-y-exec-expected.txt"
