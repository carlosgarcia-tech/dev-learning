#!/usr/bin/env bash
# Verificación: ejercicio-04-colas-de-trabajo
set -u
cd "$(dirname "$0")" || exit 1

CTR="redis-ej-$$"
SETUP="ejercicio-04-colas-de-trabajo-setup.redis"
SOL="ejercicio-04-colas-de-trabajo-solucion.redis"
EXPECTED="ejercicio-04-colas-de-trabajo-expected.txt"
