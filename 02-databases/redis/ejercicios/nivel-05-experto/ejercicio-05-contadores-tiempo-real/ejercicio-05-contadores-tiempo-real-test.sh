#!/usr/bin/env bash
# Verificación: ejercicio-05-contadores-tiempo-real
set -u
cd "$(dirname "$0")" || exit 1

CTR="redis-ej-$$"
SETUP="ejercicio-05-contadores-tiempo-real-setup.redis"
SOL="ejercicio-05-contadores-tiempo-real-solucion.redis"
EXPECTED="ejercicio-05-contadores-tiempo-real-expected.txt"
