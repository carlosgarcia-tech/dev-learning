#!/usr/bin/env bash
# Verificación: ejercicio-05-hashes-contadores
set -u
cd "$(dirname "$0")" || exit 1

CTR="redis-ej-$$"
SETUP="ejercicio-05-hashes-contadores-setup.redis"
SOL="ejercicio-05-hashes-contadores-solucion.redis"
EXPECTED="ejercicio-05-hashes-contadores-expected.txt"
