package com.ejercicio.operadoresycondicionales;
...
/**
 * Suite de tests basica para el ejercicio "Operadores y Condicionales".
...
public class MainTest {
    public static void main(String[] args) {
        ...
        try {
            Class.forName("com.ejercicio.operadoresycondicionales.Main");
