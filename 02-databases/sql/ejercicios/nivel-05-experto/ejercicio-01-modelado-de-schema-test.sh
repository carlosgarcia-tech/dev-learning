#!/usr/bin/env bash
# Verificación: ejercicio-01-modelado-de-schema
set -u
cd "$(dirname "$0")" || exit 1

DB="tmp.db"
SCHEMA="ejercicio-01-modelado-de-schema-schema.sql"
SOL="ejercicio-01-modelado-de-schema-solucion.sql"
CHECK="ejercicio-01-modelado-de-schema-check.sql"
EXPECTED="ejercicio-01-modelado-de-schema-expected.txt"
