...
check_html 'type="email"' "input email"
check_html 'required' "required"
check_html 'defer' "defer"

check_js 'addEventListener' "addEventListener"
check_js 'checkValidity' "checkValidity"
check_js 'setCustomValidity' "setCustomValidity"
check_js 'validity' "validity"
