# Ejercicio 01 — Modelado Complejo
...
Diseña un modelo completo para un sistema de ventas con clientes,
productos, categorías, pedidos, detalle de pedidos, inventario y
proveedores.
...
```bash
cd ejercicios/nivel-05-experto/ejercicio-01-modelado-complejo
bash test.sh
```
