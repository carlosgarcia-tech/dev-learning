#!/usr/bin/env bash
# Verificación: ejercicio-05-alias-y-case
set -u
cd "$(dirname "$0")" || exit 1

DB="tmp.db"
SCHEMA="ejercicio-05-alias-y-case-schema.sql"
SOL="ejercicio-05-alias-y-case-solucion.sql"
EXPECTED="ejercicio-05-alias-y-case-expected.txt"
