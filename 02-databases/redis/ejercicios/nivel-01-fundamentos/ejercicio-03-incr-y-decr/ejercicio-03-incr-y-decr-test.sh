#!/usr/bin/env bash
# Verificación: ejercicio-03-incr-y-decr
set -u
cd "$(dirname "$0")" || exit 1

CTR="redis-ej-$$"
SETUP="ejercicio-03-incr-y-decr-setup.redis"
SOL="ejercicio-03-incr-y-decr-solucion.redis"
EXPECTED="ejercicio-03-incr-y-decr-expected.txt"
