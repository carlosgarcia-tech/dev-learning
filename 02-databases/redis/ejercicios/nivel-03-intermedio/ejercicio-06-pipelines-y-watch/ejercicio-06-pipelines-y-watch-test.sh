#!/usr/bin/env bash
# Verificación: ejercicio-06-pipelines-y-watch
set -u
cd "$(dirname "$0")" || exit 1

CTR="redis-ej-$$"
SETUP="ejercicio-06-pipelines-y-watch-setup.redis"
SOL="ejercicio-06-pipelines-y-watch-solucion.redis"
EXPECTED="ejercicio-06-pipelines-y-watch-expected.txt"
