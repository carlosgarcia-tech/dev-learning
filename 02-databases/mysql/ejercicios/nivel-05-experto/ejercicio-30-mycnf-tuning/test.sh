...
# La configuración my.cnf no es SQL ejecutable. El test valida la consulta
# autónoma final que confirma que el tuning fue revisado.
set -euo pipefail
...
# Extraer solo las líneas no comentadas (la consulta ejecutable)
