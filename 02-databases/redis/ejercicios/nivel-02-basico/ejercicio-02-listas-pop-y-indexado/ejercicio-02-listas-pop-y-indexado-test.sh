#!/usr/bin/env bash
# Verificación: ejercicio-02-listas-pop-y-indexado
set -u
cd "$(dirname "$0")" || exit 1

CTR="redis-ej-$$"
SETUP="ejercicio-02-listas-pop-y-indexado-setup.redis"
SOL="ejercicio-02-listas-pop-y-indexado-solucion.redis"
EXPECTED="ejercicio-02-listas-pop-y-indexado-expected.txt"
