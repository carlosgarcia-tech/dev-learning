#!/usr/bin/env bash
# Verificación: ejercicio-05-atlas-search
set -u
cd "$(dirname "$0")" || exit 1

CTR="mongo-ej-$$"
WORK="$(pwd)"
SETUP="ejercicio-05-atlas-search-setup.js"
SOL="ejercicio-05-atlas-search-solucion.js"
EXPECTED="ejercicio-05-atlas-search-expected.txt"
