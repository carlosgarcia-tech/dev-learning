#!/usr/bin/env bash
# Verificación: ejercicio-02-streams-basicos
set -u
cd "$(dirname "$0")" || exit 1

CTR="redis-ej-$$"
SETUP="ejercicio-02-streams-basicos-setup.redis"
SOL="ejercicio-02-streams-basicos-solucion.redis"
EXPECTED="ejercicio-02-streams-basicos-expected.txt"
