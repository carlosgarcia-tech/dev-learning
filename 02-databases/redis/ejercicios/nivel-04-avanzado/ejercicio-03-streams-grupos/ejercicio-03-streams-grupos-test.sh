#!/usr/bin/env bash
# Verificación: ejercicio-03-streams-grupos
set -u
cd "$(dirname "$0")" || exit 1

CTR="redis-ej-$$"
SETUP="ejercicio-03-streams-grupos-setup.redis"
SOL="ejercicio-03-streams-grupos-solucion.redis"
EXPECTED="ejercicio-03-streams-grupos-expected.txt"
