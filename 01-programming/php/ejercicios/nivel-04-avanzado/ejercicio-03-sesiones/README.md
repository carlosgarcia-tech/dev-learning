...
Completa las funciones en `index.php`. Todas reciben la sesión **por referencia** para poder testearlas sin un servidor web (en producción se pasa `$_SESSION` tras `session_start()`):
