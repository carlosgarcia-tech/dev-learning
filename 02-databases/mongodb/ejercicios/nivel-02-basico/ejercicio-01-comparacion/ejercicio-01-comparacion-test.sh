#!/usr/bin/env bash
# Verificación: ejercicio-01-comparacion
set -u
cd "$(dirname "$0")" || exit 1

CTR="mongo-ej-$$"
WORK="$(pwd)"
SETUP="ejercicio-01-comparacion-setup.js"
SOL="ejercicio-01-comparacion-solucion.js"
EXPECTED="ejercicio-01-comparacion-expected.txt"
