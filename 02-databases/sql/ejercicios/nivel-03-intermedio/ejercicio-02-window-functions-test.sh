#!/usr/bin/env bash
# Verificación: ejercicio-02-window-functions
set -u
cd "$(dirname "$0")" || exit 1

DB="tmp.db"
SCHEMA="ejercicio-02-window-functions-schema.sql"
SOL="ejercicio-02-window-functions-solucion.sql"
EXPECTED="ejercicio-02-window-functions-expected.txt"
