#!/usr/bin/env bash
# Verificación: ejercicio-03-proyeccion
set -u
cd "$(dirname "$0")" || exit 1

CTR="mongo-ej-$$"
WORK="$(pwd)"
SETUP="ejercicio-03-proyeccion-setup.js"
SOL="ejercicio-03-proyeccion-solucion.js"
EXPECTED="ejercicio-03-proyeccion-expected.txt"
