#!/usr/bin/env bash
# Verificación: ejercicio-01-indices-basicos
set -u
cd "$(dirname "$0")" || exit 1

CTR="mongo-ej-$$"
WORK="$(pwd)"
SETUP="ejercicio-01-indices-basicos-setup.js"
SOL="ejercicio-01-indices-basicos-solucion.js"
EXPECTED="ejercicio-01-indices-basicos-expected.txt"
