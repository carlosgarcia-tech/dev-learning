#!/usr/bin/env bash
# Verificación: ejercicio-03-datos-relacionales-complejos
set -u
cd "$(dirname "$0")" || exit 1

DB="tmp.db"
SCHEMA="ejercicio-03-datos-relacionales-complejos-schema.sql"
SOL="ejercicio-03-datos-relacionales-complejos-solucion.sql"
EXPECTED="ejercicio-03-datos-relacionales-complejos-expected.txt"
