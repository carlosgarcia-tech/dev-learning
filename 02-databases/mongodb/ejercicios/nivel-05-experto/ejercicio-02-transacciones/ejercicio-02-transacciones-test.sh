#!/usr/bin/env bash
# Verificación: ejercicio-02-transacciones (REPLICA SET)
set -u
cd "$(dirname "$0")" || exit 1

CTR="mongo-rs-$$"
WORK="$(pwd)"
SETUP="ejercicio-02-transacciones-setup.js"
SOL="ejercicio-02-transacciones-solucion.js"
EXPECTED="ejercicio-02-transacciones-expected.txt"
