#!/usr/bin/env bash
# Verificación: ejercicio-05-bitmaps
set -u
cd "$(dirname "$0")" || exit 1

CTR="redis-ej-$$"
SETUP="ejercicio-05-bitmaps-setup.redis"
SOL="ejercicio-05-bitmaps-solucion.redis"
EXPECTED="ejercicio-05-bitmaps-expected.txt"
