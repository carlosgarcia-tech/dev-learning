package com.ejercicio.productorconsumidor;
...
/**
 * Suite de tests basica para el ejercicio "Productor-Consumidor".
...
public class MainTest {
    public static void main(String[] args) {
        ...
        try {
            Class.forName("com.ejercicio.productorconsumidor.Main");
