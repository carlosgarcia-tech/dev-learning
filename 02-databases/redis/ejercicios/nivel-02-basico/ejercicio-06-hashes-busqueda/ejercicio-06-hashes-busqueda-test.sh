#!/usr/bin/env bash
# Verificación: ejercicio-06-hashes-busqueda
set -u
cd "$(dirname "$0")" || exit 1

CTR="redis-ej-$$"
SETUP="ejercicio-06-hashes-busqueda-setup.redis"
SOL="ejercicio-06-hashes-busqueda-solucion.redis"
EXPECTED="ejercicio-06-hashes-busqueda-expected.txt"
