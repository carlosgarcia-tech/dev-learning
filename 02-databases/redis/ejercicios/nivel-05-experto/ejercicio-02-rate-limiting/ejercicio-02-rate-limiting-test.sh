#!/usr/bin/env bash
# Verificación: ejercicio-02-rate-limiting
set -u
cd "$(dirname "$0")" || exit 1

CTR="redis-ej-$$"
SETUP="ejercicio-02-rate-limiting-setup.redis"
SOL="ejercicio-02-rate-limiting-solucion.redis"
EXPECTED="ejercicio-02-rate-limiting-expected.txt"
