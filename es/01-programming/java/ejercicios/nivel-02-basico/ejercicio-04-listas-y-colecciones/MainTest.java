package com.ejercicio.listasycolecciones;
...
/**
 * Suite de tests basica para el ejercicio "Listas y Colecciones".
...
public class MainTest {
    public static void main(String[] args) {
        ...
        try {
            Class.forName("com.ejercicio.listasycolecciones.Main");
