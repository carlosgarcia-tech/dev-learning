#!/usr/bin/env bash
# Verificación: ejercicio-01-listas-basicas
set -u
cd "$(dirname "$0")" || exit 1

CTR="redis-ej-$$"
SETUP="ejercicio-01-listas-basicas-setup.redis"
SOL="ejercicio-01-listas-basicas-solucion.redis"
EXPECTED="ejercicio-01-listas-basicas-expected.txt"
