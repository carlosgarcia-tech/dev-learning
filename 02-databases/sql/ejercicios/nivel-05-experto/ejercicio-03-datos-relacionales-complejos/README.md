# Ejercicio 27 — Datos Relacionales Complejos
...
1. Consulta con relaciones 1:N, N:N, 1:1
2. Consulta con múltiples joins y agregaciones
3. Consulta con CTEs y window functions
