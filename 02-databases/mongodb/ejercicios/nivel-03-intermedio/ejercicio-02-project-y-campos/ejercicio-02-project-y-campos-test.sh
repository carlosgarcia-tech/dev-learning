#!/usr/bin/env bash
# Verificación: ejercicio-02-project-y-campos
set -u
cd "$(dirname "$0")" || exit 1

CTR="mongo-ej-$$"
WORK="$(pwd)"
SETUP="ejercicio-02-project-y-campos-setup.js"
SOL="ejercicio-02-project-y-campos-solucion.js"
EXPECTED="ejercicio-02-project-y-campos-expected.txt"
