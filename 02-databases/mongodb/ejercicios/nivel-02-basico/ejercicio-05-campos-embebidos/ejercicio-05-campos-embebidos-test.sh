#!/usr/bin/env bash
# Verificación: ejercicio-05-campos-embebidos
set -u
cd "$(dirname "$0")" || exit 1

CTR="mongo-ej-$$"
WORK="$(pwd)"
SETUP="ejercicio-05-campos-embebidos-setup.js"
SOL="ejercicio-05-campos-embebidos-solucion.js"
EXPECTED="ejercicio-05-campos-embebidos-expected.txt"
