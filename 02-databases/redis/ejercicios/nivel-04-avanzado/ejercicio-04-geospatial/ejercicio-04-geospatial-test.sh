#!/usr/bin/env bash
# Verificación: ejercicio-04-geospatial
set -u
cd "$(dirname "$0")" || exit 1

CTR="redis-ej-$$"
SETUP="ejercicio-04-geospatial-setup.redis"
SOL="ejercicio-04-geospatial-solucion.redis"
EXPECTED="ejercicio-04-geospatial-expected.txt"
