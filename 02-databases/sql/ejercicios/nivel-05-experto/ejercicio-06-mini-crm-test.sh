#!/usr/bin/env bash
# Verificación: ejercicio-06-mini-crm
set -u
cd "$(dirname "$0")" || exit 1

DB="tmp.db"
SCHEMA="ejercicio-06-mini-crm-schema.sql"
SOL="ejercicio-06-mini-crm-solucion.sql"
CHECK="ejercicio-06-mini-crm-check.sql"
EXPECTED="ejercicio-06-mini-crm-expected.txt"
