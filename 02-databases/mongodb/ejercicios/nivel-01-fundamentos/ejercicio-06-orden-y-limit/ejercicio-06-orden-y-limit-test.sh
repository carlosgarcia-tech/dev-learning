#!/usr/bin/env bash
# Verificación: ejercicio-06-orden-y-limit
set -u
cd "$(dirname "$0")" || exit 1

CTR="mongo-ej-$$"
WORK="$(pwd)"
SETUP="ejercicio-06-orden-y-limit-setup.js"
SOL="ejercicio-06-orden-y-limit-solucion.js"
EXPECTED="ejercicio-06-orden-y-limit-expected.txt"
