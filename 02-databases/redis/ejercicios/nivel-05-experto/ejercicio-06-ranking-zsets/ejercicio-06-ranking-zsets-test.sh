#!/usr/bin/env bash
# Verificación: ejercicio-06-ranking-zsets
set -u
cd "$(dirname "$0")" || exit 1

CTR="redis-ej-$$"
SETUP="ejercicio-06-ranking-zsets-setup.redis"
SOL="ejercicio-06-ranking-zsets-solucion.redis"
EXPECTED="ejercicio-06-ranking-zsets-expected.txt"
