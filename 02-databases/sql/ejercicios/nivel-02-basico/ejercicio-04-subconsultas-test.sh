#!/usr/bin/env bash
# Verificación: ejercicio-04-subconsultas
set -u
cd "$(dirname "$0")" || exit 1

DB="tmp.db"
SCHEMA="ejercicio-04-subconsultas-schema.sql"
SOL="ejercicio-04-subconsultas-solucion.sql"
EXPECTED="ejercicio-04-subconsultas-expected.txt"
