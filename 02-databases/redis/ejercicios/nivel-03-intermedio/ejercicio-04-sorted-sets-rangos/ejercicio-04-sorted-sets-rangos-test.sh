#!/usr/bin/env bash
# Verificación: ejercicio-04-sorted-sets-rangos
set -u
cd "$(dirname "$0")" || exit 1

CTR="redis-ej-$$"
SETUP="ejercicio-04-sorted-sets-rangos-setup.redis"
SOL="ejercicio-04-sorted-sets-rangos-solucion.redis"
EXPECTED="ejercicio-04-sorted-sets-rangos-expected.txt"
