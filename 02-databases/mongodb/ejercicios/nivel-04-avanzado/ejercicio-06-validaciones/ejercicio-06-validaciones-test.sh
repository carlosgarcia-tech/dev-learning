#!/usr/bin/env bash
# Verificación: ejercicio-06-validaciones
set -u
cd "$(dirname "$0")" || exit 1

CTR="mongo-ej-$$"
WORK="$(pwd)"
SETUP="ejercicio-06-validaciones-setup.js"
SOL="ejercicio-06-validaciones-solucion.js"
EXPECTED="ejercicio-06-validaciones-expected.txt"
