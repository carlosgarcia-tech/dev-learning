#!/usr/bin/env bash
# Verificación: ejercicio-01-expiracion-avanzada
set -u
cd "$(dirname "$0")" || exit 1

CTR="redis-ej-$$"
SETUP="ejercicio-01-expiracion-avanzada-setup.redis"
SOL="ejercicio-01-expiracion-avanzada-solucion.redis"
EXPECTED="ejercicio-01-expiracion-avanzada-expected.txt"
