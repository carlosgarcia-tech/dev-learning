#!/usr/bin/env bash
# Verificación: ejercicio-05-sort-limit-skip
set -u
cd "$(dirname "$0")" || exit 1

CTR="mongo-ej-$$"
WORK="$(pwd)"
SETUP="ejercicio-05-sort-limit-skip-setup.js"
SOL="ejercicio-05-sort-limit-skip-solucion.js"
EXPECTED="ejercicio-05-sort-limit-skip-expected.txt"
