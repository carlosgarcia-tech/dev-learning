#!/usr/bin/env bash
# Verificación: ejercicio-01-select-basico
set -u
cd "$(dirname "$0")" || exit 1

DB="tmp.db"
SCHEMA="ejercicio-01-select-basico-schema.sql"
SOL="ejercicio-01-select-basico-solucion.sql"
EXPECTED="ejercicio-01-select-basico-expected.txt"
