#!/usr/bin/env bash
# Verificación: ejercicio-05-funciones-agregadas
set -u
cd "$(dirname "$0")" || exit 1

DB="tmp.db"
SCHEMA="ejercicio-05-funciones-agregadas-schema.sql"
SOL="ejercicio-05-funciones-agregadas-solucion.sql"
EXPECTED="ejercicio-05-funciones-agregadas-expected.txt"
