#!/usr/bin/env bash
# Verificación: ejercicio-02-del-y-append
set -u
cd "$(dirname "$0")" || exit 1

CTR="redis-ej-$$"
SETUP="ejercicio-02-del-y-append-setup.redis"
SOL="ejercicio-02-del-y-append-solucion.redis"
EXPECTED="ejercicio-02-del-y-append-expected.txt"
