#!/usr/bin/env bash
# Verificación: ejercicio-06-mini-proyecto
set -u
cd "$(dirname "$0")" || exit 1

CTR="mongo-ej-$$"
WORK="$(pwd)"
SETUP="ejercicio-06-mini-proyecto-setup.js"
SOL="ejercicio-06-mini-proyecto-solucion.js"
EXPECTED="ejercicio-06-mini-proyecto-expected.txt"
