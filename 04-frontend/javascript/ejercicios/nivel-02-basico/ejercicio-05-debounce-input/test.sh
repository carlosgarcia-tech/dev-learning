...
check_html 'id="busqueda"' "input busqueda"
check_html 'defer' "defer"

check_js 'addEventListener' "addEventListener"
check_js 'input' "evento input"
check_js 'debounce' "funcion debounce"
check_js 'setTimeout' "setTimeout"
check_js 'clearTimeout' "clearTimeout"
