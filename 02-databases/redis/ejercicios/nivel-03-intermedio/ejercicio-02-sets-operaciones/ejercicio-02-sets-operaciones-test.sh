#!/usr/bin/env bash
# Verificación: ejercicio-02-sets-operaciones
set -u
cd "$(dirname "$0")" || exit 1

CTR="redis-ej-$$"
SETUP="ejercicio-02-sets-operaciones-setup.redis"
SOL="ejercicio-02-sets-operaciones-solucion.redis"
EXPECTED="ejercicio-02-sets-operaciones-expected.txt"
