#!/usr/bin/env bash
# Verificación: ejercicio-03-sesiones
set -u
cd "$(dirname "$0")" || exit 1

CTR="redis-ej-$$"
SETUP="ejercicio-03-sesiones-setup.redis"
SOL="ejercicio-03-sesiones-solucion.redis"
EXPECTED="ejercicio-03-sesiones-expected.txt"
