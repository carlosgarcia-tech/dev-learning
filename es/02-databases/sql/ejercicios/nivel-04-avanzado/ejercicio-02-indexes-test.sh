#!/usr/bin/env bash
# Verificación: ejercicio-02-indexes
set -u
cd "$(dirname "$0")" || exit 1

DB="tmp.db"
SCHEMA="ejercicio-02-indexes-schema.sql"
SOL="ejercicio-02-indexes-solucion.sql"
CHECK="ejercicio-02-indexes-check.sql"
EXPECTED="ejercicio-02-indexes-expected.txt"
